...
def run_thought_graph_inference(data, saved_thought_graph_results_toJSON: dict):
    ...
    for K in data.items():
        if K[0] in saved_thought_graph_results_toJSON:
            continue
        ...
        if validate_prediction(error_assessment, class_labels):
            ...
            saved_thought_graph_results_toJSON[K[0]] = error_assessment
            saved_thought_graph_results_toJSON[K[0]
...
def main():
    ...
    results_output_file = args.results if args.results else "llama_3.2_11B_tg_results.json"
    ...
    for b in batches:
        ...
        is_error = run_thought_graph_inference(
        ...
        if is_error:
            print("============================================================")
            print(
                "TogetherAI request issue, please check if API key has enough credits.")
            print("============================================================")
            return
